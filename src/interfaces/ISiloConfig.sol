...
interface ISiloConfig {
    ...
    function borrowerCollateralSilo(
        address _borrower
    ) external view returns (address collateralSilo);
    ...
    function getDebtSilo(
        address _borrower
    ) external view returns (address debtSilo);
