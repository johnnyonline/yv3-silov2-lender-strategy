...
interface ISiloLens {
    ...
    function getMaxLtv(
        ISilo _silo
    ) external view returns (uint256 maxLtv);
    ...
    function getLt(
        ISilo _silo
    ) external view returns (uint256 lt);
    ...
    function getInterestRateModel(
        ISilo _silo
    ) external view returns (address irm);
    ...
    function getDepositAPR(
        ISilo _silo
    ) external view returns (uint256 depositAPR);
